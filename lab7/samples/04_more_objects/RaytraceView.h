...
private:
	...
	CSceneObject& AddHyperbolicParaboloid(IShader const& shader, CMatrix4d const& transform);
	CSceneObject& AddParaboloid(IShader const& shader, CMatrix4d const& transform);
