...
constexpr double FIELD_OF_VIEW = 70 * M_PI / 180.0;
// Размер стороны
...
Window::Window(int w, int h, const char* title)
	...
	, m_cube(CUBE_SIZE)
	, m_cubeMini(CUBE_SIZE * 0.5)
{
	m_cube.SetSideColor(CubeSide::REAR_UPPER_LEFT_TRIANGLE, { 1, 1, 0, 1 });
	m_cube.SetSideColor(CubeSide::REAR_LOWER_LEFT_TRIANGLE, { 1, 0.5, 0, 1 });
	m_cube.SetSideColor(CubeSide::REAR_UPPER_RIGHT_TRIANGLE, { 0, 0, 1, 1 });
	m_cube.SetSideColor(CubeSide::REAR_LOWER_RIGHT_TRIANGLE, { 1, 0, 0, 1 });
	m_cube.SetSideColor(CubeSide::FRONT_UPPER_LEFT_TRIANGLE, { 0, 1, 1, 1 });
	m_cube.SetSideColor(CubeSide::FRONT_LOWER_LEFT_TRIANGLE, { 1, 0, 1, 1 });
	m_cube.SetSideColor(CubeSide::FRONT_UPPER_RIGHT_TRIANGLE, { 1, 0, 0, 1 });
	m_cube.SetSideColor(CubeSide::FRONT_LOWER_RIGHT_TRIANGLE, { 0.5, 1, 0.5, 1 });
	m_cube.SetSideColor(CubeSide::BACK_SQUARE, { 1, 0, 0, 1 });
	m_cube.SetSideColor(CubeSide::LEFT_SQUARE, { 0, 1, 0, 1 });
	m_cube.SetSideColor(CubeSide::RIGHT_SQUARE, { 0, 0, 1, 1 });
	m_cube.SetSideColor(CubeSide::FRONT_SQUARE, { 1, 0, 1, 1 });
	m_cube.SetSideColor(CubeSide::UPPER_SQUARE, { 0, 1, 1, 1 });
	m_cube.SetSideColor(CubeSide::BOTTOM_SQUARE, { 1, 1, 0, 1 });

	m_cube.SetSpecularColor({ 1, 1, 1, 1 });
	m_cube.SetShininess(4.0f);

	m_cubeMini = m_cube;
	m_cubeMini.SetSize(CUBE_SIZE * 0.5);
}
